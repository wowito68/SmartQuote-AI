...
from app.domain.comparison.exceptions import (
    ComparisonNotFound as ComparisonV2NotFound,
    ComparisonNotReady as ComparisonV2NotReady,
)
...
def register_exception_handlers(app: FastAPI) -> None:
    mappings = [
        ...
        (ComparisonV2NotFound, status.HTTP_404_NOT_FOUND, "comparison_not_found"),
        ...
        (ComparisonV2NotReady, status.HTTP_409_CONFLICT, "comparison_not_ready"),
