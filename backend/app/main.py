...
from app.api.routes.quote_reception import router as quote_reception_router
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        ...
        description=(
            "REST API for SmartQuote AI tender sourcing, RFQ delivery, manual quote analysis and comparison."
        ),
    )
    register_exception_handlers(application)
    application.include_router(health_router)
    application.include_router(quote_reception_router, prefix=settings.api_v1_prefix)
