...
const navItems: Array<{ key: ViewKey; label: string; icon: ReactNode }> = [
  ...
  { key: "comparison", label: "Comparativo", icon: <BarChart3 className="h-4 w-4" /> }
];
...
const pageCopy: Record<ViewKey, { title: string; description: string }> = {
  ...
  comparison: { title: "Comparativo", description: "Contrasta ofertas aprobadas con cobertura, advertencias y trazabilidad, sin seleccionar un ganador." }
};
